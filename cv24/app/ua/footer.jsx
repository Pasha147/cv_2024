...
export default function Footer() {
  return (
    <footer id="footer" className="max-w-4xl mx-auto bg-resume-section bg-gradient-cover-grid bg-no-repeat-grid bg-center-grid dark:bg-resume-section_d text-xl">
